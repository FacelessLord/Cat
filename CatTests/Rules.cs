...
namespace CatTests
{
    ...
    public class Tests
    {
        ...
        private static Token module = new Token(TokenTypes.Module, "module");
        ...
        public void ConstDefinitionRule_Works()
        {
            ...
            var node = ModuleRules.FieldDefinition.Read(new BufferedEnumerable<IToken>(tokens));

            node.Should().BeOfType<FieldDefinitionNode>();
            var constDefinition = (FieldDefinitionNode) node;
        ...
        public void ModuleRule_Works()
        {
            ...
            var constDef = (FieldDefinitionNode) moduleNode.Objects[1];
